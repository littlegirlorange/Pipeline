...
TASK_FILE = "M:\\maggieData\\Lara\\LaraBenignListRedo20160513.txt"
DCM_INPUT_DIRECTORY = "M:\\maggieData\\Benign"
# Output location.
OUTPUT_DIRECTORY = "M:\\maggieData\\Lara\\Benign"
# File name indices.
FILENAME_INDICES = {"CADPatID":0, "DICOM_NO":1, "SERIES_DATE":2, "ACCESSION_NO":3, "SERIES_NO":4, "SERIES_DESC":5}
...
# Subtraction image calculation parameters.
# --------------------------------------------
# Input image parameters.
SUBTRACTION_PRECONTRAST_IMG_TYPE_FILTER = "_Sag.VIBRANT.MPH.mha"
SUBTRACTION_POSTCONTRAST_IMG_TYPE_FILTER = "_Ph*Sag.VIBRANT.MPH_mc.mha"
SUBTRACTION_OUTPUT_IMG_TYPE_FILTER = "_???-???.mha"
...
ELASTIX_EXE = "D:\\Work\\BreastCAD\\Pipeline\\bin\\elastix.exe"
...
TRANSFORMIX_IMG_TYPE_FILTER = [ANN_PRECONTRAST_IMG_TYPE_FILTER, ANN_POSTCONTRAST_IMG_TYPE_FILTER, "LesionProbMap.mha", RFSEGMENTATION_OUTPUT_FILE_POSTFIX, SUBTRACTION_OUTPUT_IMG_TYPE_FILTER]
